...
class RealTimePrediction:
    def __init__(self):
        self.pre_model_pth = "./weights/reconstruction_weight_LS_64_3bjects_240912.pth"#1/5
        self.width = 320
        self.height = 320
        self.batch_size = 32
...
if __name__ == "__main__":
    ...
    # 模型加载 #2/5
    saved_pth = ["./weights/pose_weight_masterball_0912.pth","./weights/pose_weight_peach_0912.pth","./weights/pose_weight_cover_0912.pth"]#2/4
    #saved_pth = ["./weights/pose_weight_masterball_0907.pth"]#1/
    weight_path = saved_pth[0]  
    pre_model_pth = "./weights/reconstruction_weight_LS_64_3bjects_240912.pth"#3/5
    ...
    # 读取图像
    img_left = cv2.imread('./IMG_DATA_LS/IMG_DATA_MASTERBALL_0907/IMG_LEFT/00004540.jpg')#4/5
    img_right = cv2.imread('./IMG_DATA_LS/IMG_DATA_MASTERBALL_0907/IMG_RIGHT/00004540.jpg')
    img_behind = cv2.imread('./IMG_DATA_LS/IMG_DATA_MASTERBALL_0907/IMG_BEHIND/00004540.jpg')
    img_outside = cv2.imread('./IMG_DATA_LS/IMG_DATA_MASTERBALL_0907/IMG_OUTSIDE/00004540.jpg')
    ...
    if img_left is None or img_right is None or img_outside is None:
        ...
        if result_pose is not False:
            ...
            a = RawDataTransfer("./IMG_DATA_LS/IMG_DATA_MASTERBALL_0907/Pose_Init")#5/5
            ...
            GroundTruthPOSE = np.hstack((transfer_matrix[0:3,3], rotation_vect))
        ...
        outputs = pose_model(imgLeft, imgRight, imgBehind, joint_config)#LiS240826 behind
