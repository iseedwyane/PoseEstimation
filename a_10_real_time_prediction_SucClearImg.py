...
if __name__ == "__main__":
    ...
    #CAP = MultiVideoCapture(cameraID_outside=36, cameraID_left=37, cameraID_right=34)
    ...
    file_path = "./IMG_DATA_LS/IMG_DATA_BASEBALL_0628/Pose_Init"
        ...
        try:
            while True:
                ...
                if cv2.waitKey(1) & 0xFF == ord('q'):
                    break                
                img_left= cv2.imread('./IMG_DATA_LS/IMG_DATA_BASEBALL_0628/IMG_LEFT/00000000.jpg')
                img_right=cv2.imread('./IMG_DATA_LS/IMG_DATA_BASEBALL_0628/IMG_RIGHT/00000000.jpg')
                ...
                if result_pose is not False:
                    ...
                    print("GroundTruthPOSE:", GroundTruthPOSE)
                ...
                if outputs.numel() > 1:  # 确保outputs有多个元素
                    second_value = outputs[0, 1].item()  # 取第一行的第二个元素
                    print("Second value -- Predicted POSE as scalar:", second_value)
                ...
                GRIPPER_PD_value = abs(ref - second_value)#100-80
                new_position = abs(55-GRIPPER_PD_value)
                new_position = max(30,min(90,new_position)) # 30<=newposition<=90
                print("new_position value:", new_position)
