...
# Serial setup
ser = serial.Serial('/dev/ttyACM0', 115200)  # Replace with actual port number
...
if __name__ == "__main__":
    ...
    CAP = MultiVideoCapture(cameraID_outside=8, cameraID_left=6, cameraID_right=0, cameraID_behind=11)
    ...
    # 创建并打开CSV文件以追加模式写入数据
    output_directory = '/home/sen/Documents/InHand_pose/IMG_DATA_LS/IMG_DATA_PEACH_241226/PredictionTrails/'
    # 确保文件夹存在，如果不存在则创建 
