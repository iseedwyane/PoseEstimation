...
if __name__ == "__main__":
    ...
    file_path = "./IMG_DATA_LS/IMG_DATA_BASEBALL_0628-113856/Pose_Init"
        ...
        try:
            ...
            while i<1000:
                ...
                if result_pose is not False:
                    ...
                    print("GroundTruth POSE:", GroundTruthPOSE[1])
                ...
                if outputs.numel() > 1:  # 确保outputs有多个元素
                    ...
                    print("Predicted POSE:", second_value)
                ...
                Object_size=0.85
                GRIPPER_PD_value = Object_size*abs(ref - second_value)#100-80
                new_position = abs(GRIPPER_PD_value)
                new_position = max(50,min(80,new_position)) # 30<=newposition<=85
