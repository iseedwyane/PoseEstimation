...
# Created by LiuXb on 2020/12/24
# -*- coding:utf-8 -*-
...
class TrainEncoderDecoder(object):
    def __init__(self):
        ...
        self.momentum = 0.3
        self.epoch = 200
        self.saved_pth = './weights/reconstruction_weight_LS_64_BaseballOnly_0828.pth'
        ...
        #self.data_folder_train = ["./IMG_DATA_LS/IMG_DATA_tri_baseball_5000/train.txt","./IMG_DATA_LS/IMG_DATA_tri_bottlecover_5000/train.txt","./IMG_DATA_LS/IMG_DATA_tri_cube_5000/train.txt","./IMG_DATA_LS/IMG_DATA_tri_strawberry_5000/train.txt","./IMG_DATA_LS/IMG_DATA_tri_can_5000/train.txt"]
        #self.data_folder_var = ["./IMG_DATA_LS/IMG_DATA_tri_baseball_5000/var.txt","./IMG_DATA_LS/IMG_DATA_tri_bottlecover_5000/var.txt","./IMG_DATA_LS/IMG_DATA_tri_cube_5000/var.txt","./IMG_DATA_LS/IMG_DATA_tri_strawberry_5000/var.txt","./IMG_DATA_LS/IMG_DATA_tri_can_5000/var.txt"]
        self.data_folder_train = ["./IMG_DATA_LS/IMG_DATA_BASEBALL_0828/train.txt"]#2/3
        self.data_folder_var = ["./IMG_DATA_LS/IMG_DATA_BASEBALL_0828/var.txt"]#3/3
