...
class RealTimePrediction:
    def __init__(self):
        self.pre_model_pth = "./weights/reconstruction_weight_PEACH_241226.pth"#3/5
        self.width = 320
        self.height = 320
        self.batch_size = 32
...
if __name__ == "__main__":
    ...
    CAP = MultiVideoCapture(cameraID_outside=8, cameraID_left=6, cameraID_right=0, cameraID_behind=10)#4/5
    saved_pth = ["./weights/pose_weight_peach_241226.pth"]#`1/5
        #saved_pth = ["./weights/pose_weight_baseball_0807.pth"]    
    weight_path = saved_pth[0]
    print(weight_path)  
    time.sleep(3)
    pre_model_pth = "./weights/reconstruction_weight_PEACH_241226.pth"#2/5
    ...
    file_path = "./IMG_DATA_LS/IMG_DATA_PEACH_241226/Pose_Init"#5/5
