...
class TrainRegression(object):
    def __init__(self):
        ...
        self.momentum = 0.3
        self.epoch = 1
        self.pre_model_pth = "./weights/reconstruction_weight_J2_250801.pth"#1/4
...
if __name__ == "__main__":
    ...
    saved_path = ["./weights/pose_weight_j2_250801.pth"]#2/4
    ...
    data_path = ["IMG_DATA_J2_250801"]#3/4
    error_list = ["error_j2_0801_test"]#4/4
